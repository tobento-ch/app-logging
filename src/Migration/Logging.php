...
namespace Tobento\App\Logging\Migration;
 ...
 * Logging migration.
 */
class Logging implements MigrationInterface
{
    /**
     * @var array The files.
     */
    ...
    public function install(): ActionsInterface
    {
        return new Actions(
            new FilesCopy(
                files: $this->files,
                type: 'config',
                description: 'Logging config file.',
            ),
        );
    }
